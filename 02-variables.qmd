...
- We will look at error messages in detail [later](17-scope.qmd#reading-error-messages).
...
number. In the [next lesson on types and type conversion](03-types-conversion.qmd)
