...
- Helpful as a starting point for collecting values
  (which we will see in the [next episode](12-for-loops.qmd)).
...
- Python reports an `IndexError` if we attempt to access a value that doesn't exist.
  - This is a kind of [runtime error](04-built-in.qmd).
...
Why 'up to'? As we saw in [episode 2](02-variables.qmd),
